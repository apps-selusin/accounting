...
select
    ...
    , ak.kode
    , ak.nama
    , case when isnull(j.createon) then '0000-01-01 00:00:00' else j.createon end as tanggal
    , j.nomer as no_tran
...
set @a:=0;
SELECT lr.id,lr.kode,lr.nama,lr.saldoAwal,lr.SaldoAkhir,@a:=@a + lr.SaldoAkhir as labarugi
FROM
(
...
(7, 1, 2, NULL, NULL, NULL, 2600001.000),
