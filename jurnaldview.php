...
$jurnald_view = NULL; // Initialize page object first

class cjurnald_view extends cjurnald {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "jurnaldlist.php"; // No matching record, return to list
					} else {
						$this->LoadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$sReturnUrl = "jurnaldlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($jurnald_view)) $jurnald_view = new cjurnald_view();

// Page init
$jurnald_view->Page_Init();

// Page main
$jurnald_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$jurnald_view->Page_Render();
?>
...
var CurrentForm = fjurnaldview = new ew_Form("fjurnaldview", "view");

// Form_CustomValidate event
fjurnaldview.Form_CustomValidate = 
...
fjurnaldview.ValidateRequired = true;
<?php } else { ?>
fjurnaldview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fjurnaldview.Lists["x_akun_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"akun"};
...
<div class="ewToolbar">
<?php if (!$jurnald_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $jurnald_view->ExportOptions->Render("body") ?>
<?php
	foreach ($jurnald_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$jurnald_view->IsModal) { ?>
...
<?php $jurnald_view->ShowPageHeader(); ?>
<?php
$jurnald_view->ShowMessage();
?>
<form name="fjurnaldview" id="fjurnaldview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($jurnald_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $jurnald_view->Token ?>">
<?php } ?>
...
<?php if ($jurnald->jurnal_id->Visible) { // jurnal_id ?>
	<tr id="r_jurnal_id">
		<td><span id="elh_jurnald_jurnal_id"><?php echo $jurnald->jurnal_id->FldCaption() ?></span></td>
...
<?php echo $jurnald->jurnal_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jurnald->akun_id->Visible) { // akun_id ?>
	<tr id="r_akun_id">
		<td><span id="elh_jurnald_akun_id"><?php echo $jurnald->akun_id->FldCaption() ?></span></td>
...
<?php echo $jurnald->akun_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jurnald->debet->Visible) { // debet ?>
	<tr id="r_debet">
		<td><span id="elh_jurnald_debet"><?php echo $jurnald->debet->FldCaption() ?></span></td>
...
<?php echo $jurnald->debet->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($jurnald->kredit->Visible) { // kredit ?>
	<tr id="r_kredit">
		<td><span id="elh_jurnald_kredit"><?php echo $jurnald->kredit->FldCaption() ?></span></td>
...
<?php echo $jurnald->kredit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if (!$jurnald_view->IsModal) { ?>
<?php if (!isset($jurnald_view->Pager)) $jurnald_view->Pager = new cPrevNextPager($jurnald_view->StartRec, $jurnald_view->DisplayRecs, $jurnald_view->TotalRecs) ?>
<?php if ($jurnald_view->Pager->RecordCount > 0 && $jurnald_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($jurnald_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $jurnald_view->PageUrl() ?>start=<?php echo $jurnald_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($jurnald_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $jurnald_view->PageUrl() ?>start=<?php echo $jurnald_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $jurnald_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($jurnald_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $jurnald_view->PageUrl() ?>start=<?php echo $jurnald_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($jurnald_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $jurnald_view->PageUrl() ?>start=<?php echo $jurnald_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $jurnald_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
