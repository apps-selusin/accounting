...
$periode_add = NULL; // Initialize page object first

class cperiode_add extends cperiode {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "periodeview.php")
...
// Create page object
if (!isset($periode_add)) $periode_add = new cperiode_add();

// Page init
$periode_add->Page_Init();

// Page main
$periode_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$periode_add->Page_Render();
?>
...
var CurrentForm = fperiodeadd = new ew_Form("fperiodeadd", "add");

// Validate form
fperiodeadd.Validate = function() {
...
fperiodeadd.Form_CustomValidate = 
...
fperiodeadd.ValidateRequired = true;
<?php } else { ?>
fperiodeadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $periode_add->ShowPageHeader(); ?>
<?php
$periode_add->ShowMessage();
?>
<form name="fperiodeadd" id="fperiodeadd" class="<?php echo $periode_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($periode_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $periode_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $periode_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
