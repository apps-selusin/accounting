...
$kurs_edit = NULL; // Initialize page object first

class ckurs_edit extends ckurs {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// tanggal
			$this->tanggal->SetDbValueDef($rsnew, $this->tanggal->CurrentValue, NULL, $this->tanggal->ReadOnly);
...
// Create page object
if (!isset($kurs_edit)) $kurs_edit = new ckurs_edit();
...
var CurrentForm = fkursedit = new ew_Form("fkursedit", "edit");

// Validate form
fkursedit.Validate = function() {
...
fkursedit.ValidateRequired = true;
<?php } else { ?>
fkursedit.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $kurs_edit->ShowPageHeader(); ?>
<?php
$kurs_edit->ShowMessage();
?>
<form name="fkursedit" id="fkursedit" class="<?php echo $kurs_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($kurs_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $kurs_edit->Token ?>">
<?php } ?>
