...
//
// Table class for saldoawal
//
class csaldoawal extends cTable {
	var $id;
	var $periode_id;
	var $akun_id;
	var $debet;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('saldoawal', 'saldoawal', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// periode_id
		$this->periode_id = new cField('saldoawal', 'saldoawal', 'x_periode_id', 'periode_id', '`periode_id`', '`periode_id`', 3, -1, FALSE, '`periode_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// debet
		$this->debet = new cField('saldoawal', 'saldoawal', 'x_debet', 'debet', '`debet`', '`debet`', 4, -1, FALSE, '`debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kredit
		$this->kredit = new cField('saldoawal', 'saldoawal', 'x_kredit', 'kredit', '`kredit`', '`kredit`', 200, -1, FALSE, '`kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kredit->Sortable = TRUE; // Allow sort
		$this->fields['kredit'] = &$this->kredit;

		// user_id
		$this->user_id = new cField('saldoawal', 'saldoawal', 'x_user_id', 'user_id', '`user_id`', '`user_id`', 3, -1, FALSE, '`user_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user_id->Sortable = TRUE; // Allow sort
		$this->user_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['user_id'] = &$this->user_id;

		// saldo
		$this->saldo = new cField('saldoawal', 'saldoawal', 'x_saldo', 'saldo', '`saldo`', '`saldo`', 5, -1, FALSE, '`saldo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`saldoawal`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("saldoawalview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("saldoawalview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "saldoawaladd.php?" . $this->UrlParm($parm);
		else
			$url = "saldoawaladd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("saldoawaledit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("saldoawaladd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("saldoawaldelete.php", $this->UrlParm());
	}
