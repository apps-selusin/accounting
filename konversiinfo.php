...
//
class ckonversi extends cTable {
	var $id;
	var $satuan_id;
	var $nilai;
	var $satuan_id2;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('konversi', 'konversi', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// satuan_id
		$this->satuan_id = new cField('konversi', 'konversi', 'x_satuan_id', 'satuan_id', '`satuan_id`', '`satuan_id`', 3, -1, FALSE, '`satuan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nilai
		$this->nilai = new cField('konversi', 'konversi', 'x_nilai', 'nilai', '`nilai`', '`nilai`', 5, -1, FALSE, '`nilai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// satuan_id2
		$this->satuan_id2 = new cField('konversi', 'konversi', 'x_satuan_id2', 'satuan_id2', '`satuan_id2`', '`satuan_id2`', 3, -1, FALSE, '`satuan_id2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// operasi
		$this->operasi = new cField('konversi', 'konversi', 'x_operasi', 'operasi', '`operasi`', '`operasi`', 3, -1, FALSE, '`operasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->operasi->Sortable = TRUE; // Allow sort
		$this->operasi->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['operasi'] = &$this->operasi;

		// id_FK
		$this->id_FK = new cField('konversi', 'konversi', 'x_id_FK', 'id_FK', '`id_FK`', '`id_FK`', 3, -1, FALSE, '`id_FK`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`konversi`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("konversiview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("konversiview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "konversiadd.php?" . $this->UrlParm($parm);
		else
			$url = "konversiadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("konversiedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("konversiadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("konversidelete.php", $this->UrlParm());
	}
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->operasi->Exportable) $Doc->ExportCaption($this->operasi);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->operasi->Exportable) $Doc->ExportField($this->operasi);
