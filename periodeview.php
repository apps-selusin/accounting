...
$periode_view = NULL; // Initialize page object first

class cperiode_view extends cperiode {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			$sReturnUrl = "periodelist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($periode_view)) $periode_view = new cperiode_view();

// Page init
$periode_view->Page_Init();

// Page main
$periode_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$periode_view->Page_Render();
?>
...
var CurrentForm = fperiodeview = new ew_Form("fperiodeview", "view");

// Form_CustomValidate event
fperiodeview.Form_CustomValidate = 
...
fperiodeview.ValidateRequired = true;
<?php } else { ?>
fperiodeview.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $periode_view->ExportOptions->Render("body") ?>
<?php
	foreach ($periode_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$periode_view->IsModal) { ?>
...
<?php $periode_view->ShowPageHeader(); ?>
<?php
$periode_view->ShowMessage();
?>
<form name="fperiodeview" id="fperiodeview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($periode_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $periode_view->Token ?>">
<?php } ?>
...
<?php echo $periode->start->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
