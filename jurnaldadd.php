...
$jurnald_add = NULL; // Initialize page object first

class cjurnald_add extends cjurnald {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "jurnaldview.php")
...
// Create page object
if (!isset($jurnald_add)) $jurnald_add = new cjurnald_add();

// Page init
$jurnald_add->Page_Init();

// Page main
$jurnald_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$jurnald_add->Page_Render();
?>
...
var CurrentForm = fjurnaldadd = new ew_Form("fjurnaldadd", "add");

// Validate form
fjurnaldadd.Validate = function() {
...
fjurnaldadd.Form_CustomValidate = 
...
fjurnaldadd.ValidateRequired = true;
<?php } else { ?>
fjurnaldadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $jurnald_add->ShowPageHeader(); ?>
<?php
$jurnald_add->ShowMessage();
?>
<form name="fjurnaldadd" id="fjurnaldadd" class="<?php echo $jurnald_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($jurnald_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $jurnald_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $jurnald_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
