...
class cjurnald extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('jurnald', 'jurnald', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// jurnal_id
		$this->jurnal_id = new cField('jurnald', 'jurnald', 'x_jurnal_id', 'jurnal_id', '`jurnal_id`', '`jurnal_id`', 3, -1, FALSE, '`jurnal_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// debet
		$this->debet = new cField('jurnald', 'jurnald', 'x_debet', 'debet', '`debet`', '`debet`', 4, -1, FALSE, '`debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kredit
		$this->kredit = new cField('jurnald', 'jurnald', 'x_kredit', 'kredit', '`kredit`', '`kredit`', 4, -1, FALSE, '`kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`jurnald`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("jurnaldview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("jurnaldview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "jurnaldadd.php?" . $this->UrlParm($parm);
		else
			$url = "jurnaldadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("jurnaldedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("jurnaldadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("jurnalddelete.php", $this->UrlParm());
	}
