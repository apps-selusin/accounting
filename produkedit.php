...
class cproduk_edit extends cproduk {
	...
	function Page_Main() {
		...
		if ($this->TotalRecs <= 0) { // No record found
			...
			$this->Page_Terminate("produklist.php"); // Return to list page
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// kelompok_id
			$this->kelompok_id->SetDbValueDef($rsnew, $this->kelompok_id->CurrentValue, NULL, $this->kelompok_id->ReadOnly);
			...
			// gudang_id
			$this->gudang_id->SetDbValueDef($rsnew, $this->gudang_id->CurrentValue, NULL, $this->gudang_id->ReadOnly);

			// minstok
			$this->minstok->SetDbValueDef($rsnew, $this->minstok->CurrentValue, NULL, $this->minstok->ReadOnly);

			// minorder
			$this->minorder->SetDbValueDef($rsnew, $this->minorder->CurrentValue, NULL, $this->minorder->ReadOnly);

			// akunhpp
			$this->akunhpp->SetDbValueDef($rsnew, $this->akunhpp->CurrentValue, NULL, $this->akunhpp->ReadOnly);

			// akunjual
			$this->akunjual->SetDbValueDef($rsnew, $this->akunjual->CurrentValue, NULL, $this->akunjual->ReadOnly);

			// akunpersediaan
			$this->akunpersediaan->SetDbValueDef($rsnew, $this->akunpersediaan->CurrentValue, NULL, $this->akunpersediaan->ReadOnly);

			// akunreturjual
			$this->akunreturjual->SetDbValueDef($rsnew, $this->akunreturjual->CurrentValue, NULL, $this->akunreturjual->ReadOnly);

			// hargapokok
			$this->hargapokok->SetDbValueDef($rsnew, $this->hargapokok->CurrentValue, NULL, $this->hargapokok->ReadOnly);
			...
			// t
			$this->t->SetDbValueDef($rsnew, $this->t->CurrentValue, NULL, $this->t->ReadOnly);

			// berat
			$this->berat->SetDbValueDef($rsnew, $this->berat->CurrentValue, NULL, $this->berat->ReadOnly);

			// supplier_id
			$this->supplier_id->SetDbValueDef($rsnew, $this->supplier_id->CurrentValue, NULL, $this->supplier_id->ReadOnly);

			// waktukirim
			$this->waktukirim->SetDbValueDef($rsnew, $this->waktukirim->CurrentValue, NULL, $this->waktukirim->ReadOnly);
...
var CurrentForm = fprodukedit = new ew_Form("fprodukedit", "edit");
...
?>
<form name="fprodukedit" id="fprodukedit" class="<?php echo $produk_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<?php if ($produk->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_produk_id" class="col-sm-2 control-label ewLabel"><?php echo $produk->id->FldCaption() ?></label>
...
<input type="hidden" data-table="produk" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($produk->id->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $produk_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php if (!isset($produk_edit->Pager)) $produk_edit->Pager = new cPrevNextPager($produk_edit->StartRec, $produk_edit->DisplayRecs, $produk_edit->TotalRecs) ?>
<?php if ($produk_edit->Pager->RecordCount > 0 && $produk_edit->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($produk_edit->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $produk_edit->PageUrl() ?>start=<?php echo $produk_edit->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($produk_edit->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $produk_edit->PageUrl() ?>start=<?php echo $produk_edit->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $produk_edit->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($produk_edit->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $produk_edit->PageUrl() ?>start=<?php echo $produk_edit->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($produk_edit->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $produk_edit->PageUrl() ?>start=<?php echo $produk_edit->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $produk_edit->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
<?php } ?>
