...
//
// Table class for kurs
//
class ckurs extends cTable {
	var $id;
	var $matauang_id;
	var $tanggal;
	var $nilai;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('kurs', 'kurs', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// tanggal
		$this->tanggal = new cField('kurs', 'kurs', 'x_tanggal', 'tanggal', '`tanggal`', '`tanggal`', 3, -1, FALSE, '`tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal->Sortable = TRUE; // Allow sort
		$this->tanggal->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['tanggal'] = &$this->tanggal;

		// nilai
		$this->nilai = new cField('kurs', 'kurs', 'x_nilai', 'nilai', '`nilai`', '`nilai`', 3, -1, FALSE, '`nilai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`kurs`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("kursview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("kursview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "kursadd.php?" . $this->UrlParm($parm);
		else
			$url = "kursadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("kursedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("kursadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("kursdelete.php", $this->UrlParm());
	}
