...
$jurnald_grid = NULL; // Initialize page object first

class cjurnald_grid extends cjurnald {
	...
	// Page object name
	var $PageObjName = 'jurnald_grid';

	// Grid form hidden field names
	var $FormName = 'fjurnaldgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["jurnald"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "jurnal") {
			...
			if ($GLOBALS["jurnal"]->EventCancelled) $this->EventCancelled = TRUE;
		}
