...
//
// Table class for subgrup
//
class csubgrup extends cTable {
	var $id;
	var $grup_id;
	var $kode;
	var $nama;
	...
	function __construct() {
		...
		$this->TableVar = 'subgrup';
		$this->TableName = 'subgrup';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`subgrup`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('subgrup', 'subgrup', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// kode
		$this->kode = new cField('subgrup', 'subgrup', 'x_kode', 'kode', '`kode`', '`kode`', 200, -1, FALSE, '`kode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode->Sortable = TRUE; // Allow sort
		$this->fields['kode'] = &$this->kode;

		// nama
		$this->nama = new cField('subgrup', 'subgrup', 'x_nama', 'nama', '`nama`', '`nama`', 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`subgrup`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("subgrupview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("subgrupview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "subgrupadd.php?" . $this->UrlParm($parm);
		else
			$url = "subgrupadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("subgrupedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("subgrupadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("subgrupdelete.php", $this->UrlParm());
	}
