...
$subgrup_grid = NULL; // Initialize page object first

class csubgrup_grid extends csubgrup {
	...
	// Page object name
	var $PageObjName = 'subgrup_grid';

	// Grid form hidden field names
	var $FormName = 'fsubgrupgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["subgrup"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_grup_id") && $objForm->HasValue("o_grup_id") && $this->grup_id->CurrentValue <> $this->grup_id->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->grup_id->setOldValue($objForm->GetValue("o_grup_id"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "grup") {
			$this->grup_id->Visible = FALSE;
			if ($GLOBALS["grup"]->EventCancelled) $this->EventCancelled = TRUE;
		}
