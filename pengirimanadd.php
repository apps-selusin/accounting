...
$pengiriman_add = NULL; // Initialize page object first

class cpengiriman_add extends cpengiriman {
	...
	// Page object name
	var $PageObjName = 'pengiriman_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "pengirimanview.php")
	...
	function LoadDefaultValues() {
		...
		$this->akunbeli->CurrentValue = NULL;
		$this->akunbeli->OldValue = $this->akunbeli->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// akunbeli
		$this->akunbeli->SetDbValueDef($rsnew, $this->akunbeli->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($pengiriman_add)) $pengiriman_add = new cpengiriman_add();

// Page init
$pengiriman_add->Page_Init();

// Page main
$pengiriman_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$pengiriman_add->Page_Render();
?>
...
var CurrentForm = fpengirimanadd = new ew_Form("fpengirimanadd", "add");

// Validate form
fpengirimanadd.Validate = function() {
...
fpengirimanadd.Form_CustomValidate = 
...
fpengirimanadd.ValidateRequired = true;
<?php } else { ?>
fpengirimanadd.ValidateRequired = false; 
<?php } ?>
...
<?php } ?>
<?php $pengiriman_add->ShowPageHeader(); ?>
<?php
$pengiriman_add->ShowMessage();
?>
<form name="fpengirimanadd" id="fpengirimanadd" class="<?php echo $pengiriman_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($pengiriman_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $pengiriman_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $pengiriman_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
