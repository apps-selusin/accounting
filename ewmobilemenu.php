...
$RootMenu->AddMenuItem(23, "mmci_Setup", $Language->MenuPhrase("23", "MenuText"), "", -1, "", TRUE, TRUE, TRUE);
...
$RootMenu->AddMenuItem(48, "mmci_Akun", $Language->MenuPhrase("48", "MenuText"), "", 23, "", TRUE, TRUE, TRUE);
